...
void criar_series_iniciais(Serie** inicio) {
    Serie* serie1 = criar_serie(1, 8, ESCOLHA_MULTIPLA, 10);
    Serie* serie2 = criar_serie(2, 7, VERDADEIRO_FALSO, 5);
    Serie* serie3 = criar_serie(3, 6, ESCOLHA_MULTIPLA, 10);
    Serie* serie4 = criar_serie(4, 5, VERDADEIRO_FALSO, 5);
